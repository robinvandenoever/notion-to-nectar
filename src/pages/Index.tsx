      ...
      {apiaries.map(apiary => (
        <div key={apiary} className="mb-8">
            ...
            <div className="ml-auto">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem onClick={() => { setRenameTarget(apiary); setRenameValue(apiary); setRenameOpen(true); }}>
                    <Pencil className="w-4 h-4 mr-2" /> Rename
                  </DropdownMenuItem>
                  <DropdownMenuItem className="text-destructive" onClick={() => { setDeleteTarget(apiary); setDeleteOpen(true); }}>
          ...
          <div className="grid gap-3">
            {hives.filter(h => h.apiary === apiary).map(hive => (
      ...
      <Dialog open={renameOpen} onOpenChange={setRenameOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleRename} className="gradient-honey text-primary-foreground">Save</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
